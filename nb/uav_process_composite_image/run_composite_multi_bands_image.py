...
def runscript(directory, outimg):
    ...
    """
    print("run composite multi_bands_image")
    import composite_multi_bands_image
    print("imported composite multi_bands_image")
    composite_multi_bands_image.mainRoutine(directory, outimg)
...
def main():
    ...
    cmdargs = getCmdargs()
    print("command arguments collected")
    directory = cmdargs.directory
    #ref20 = cmdargs.ref20
    outimg = cmdargs.outfile
    print("Command arguments: ", directory, outimg)
