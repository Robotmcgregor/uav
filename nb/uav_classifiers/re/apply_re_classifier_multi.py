#!/usr/bin/env python
"""
this script applies the rededge classifer to a list of rededge (UAV) imagery 
Author: Grant Staben
Date: 16/07/2019
"""
...
def applyModel(imglist,directory):
    ...
    for index, row in df.iterrows():
        ...
        outfile = directory + fileN[:-4] + '_re_class.tif'
        ...
        cmd = "python PP_C_RedEdge_Model_V2.py --reffile %s --outfile %s"% (dji_image,outfile) 
